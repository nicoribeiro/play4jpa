...
public interface Query<T> {
    ...
    /**
     * Add greater-or-equal constraint for single field value
     *
     * @param field Field to constrain
     * @param value Constraint value
     * @return this (for method chaining)
    ...
    /**
     * Add greater-or-equal constraint for two fields 
     *
     * @param field1 First Field
     * @param field2 Second Field
     * @return this (for method chaining)
    ...
    /**
     * Add greater-than constraint for single field value 
     *
     * @param field Field to constrain
     * @param value Constraint value
     * @return this (for method chaining)
    ...
    /**
     * Add greater-than constraint for two fields
     *
     * @param field1 First Field
     * @param field2 Second Field
     * @return this (for method chaining)
    ...
    /**
     * Add lower-or-equal constraint for single field value 
     *
     * @param field Field to constrain
     * @param value Constraint value
     * @return this (for method chaining)
    ...
    /**
     * Add lower-or-equal constraint for two fields 
     *
     * @param field1 First Field
     * @param field2 Second Field
     * @return this (for method chaining)
    ...
    /**
     * Add lower-than constraint for single field value 
     *
     * @param field Field to constrain
     * @param value Constraint value
     * @return this (for method chaining)
    ...
    /**
     * Add lower-than constraint for two fields 
     *
     * @param field1 First Field
     * @param field2 Second Field
     * @return this (for method chaining)
    ...
    /**
     * Add BETWEEN constraint for single field value 
     *
     * @param field Field to constrain
    ...
    /**
     * Add NOT IN constraint for single field value 
     *
     * @param field  Field to constrain
     * @param values Constraint values
     * @return this (for method chaining)
